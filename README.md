...
CametaChat é uma aplicação de mensagens em tempo real com suporte a texto, mídias e chamadas, disponível na Web e no Android (WebView).
...
- Pastas locais no PC: `CametaChat/Media` com estrutura organizada.
